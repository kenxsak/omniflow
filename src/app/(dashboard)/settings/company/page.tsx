...
export default function CompanySettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'basic' | 'location' | 'contact' | 'account'>('basic');
  ...
  const tabs = [
    { id: 'basic' as const, label: 'Basic Info', icon: 'solar:buildings-2-linear' },
    { id: 'location' as const, label: 'Location & Currency', icon: 'solar:globe-linear' },
    { id: 'contact' as const, label: 'Contact Info', icon: 'solar:phone-linear' },
    { id: 'account' as const, label: 'Account', icon: 'solar:info-circle-linear' },
  ];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            {isAdmin ? 'Manage your organization profile and settings' : 'View your organization details'}
          </p>
        </div>
        {isAdmin && (
        ...
        <div className="max-w-4xl">
          ...
          >
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <p className="text-sm font-mono bg-stone-50 dark:bg-stone-900 px-3 py-2 rounded-lg border border-stone-200 dark:border-stone-800 truncate">
                {company.id}
              </p>
            </div>
            <div>
