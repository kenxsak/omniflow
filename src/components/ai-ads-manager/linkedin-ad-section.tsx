...
const LinkedInAdSectionComponent: React.FC<LinkedInAdSectionProps> = ({
  ...
  return (
    <Card ref={linkedinAdGeneratorRef}>
        <CardHeader>
          <CardTitle className="flex items-center"><Linkedin className="mr-2 h-5 w-5 text-muted-foreground" />LinkedIn Ads Professional Suite</CardTitle>
          <CardDescription>
